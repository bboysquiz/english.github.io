...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
		...
		<h3> Добавить тему</h3>
					...
					<h4>Название темы:</h4>
					<br><input class="theme_name" type="text" name="text_name" ></input>
					<h4>Английский текст:</h4>
					<br><p><textarea rows="7" cols="100" name="text_content" > </textarea></p>
					<h4>Перевод текста:</h4>
					<br><p><textarea rows="7" cols="100" name="text_translate" > </textarea></p>
					<input value ="добавить" name="do_add_text" type="submit">
				</form>
		</div>
	    <!-- Footer -->
	    	    <div class="footer">
